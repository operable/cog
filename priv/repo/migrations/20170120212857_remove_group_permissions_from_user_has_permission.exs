defmodule Cog.Repo.Migrations.RemoveGroupPermissionsFromUserHasPermission do
  use Ecto.Migration
...
$$;
  ...
  def down do
    Code.eval_file("20151001173130_permission_check_handles_user_role_grants.exs", __DIR__)
    Cog.Repo.Migrations.PermissionCheckHandlesUserRoleGrants.up()
  end
end
