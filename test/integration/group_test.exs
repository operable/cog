defmodule Integration.GroupTest do
  ...
  test "adding a user to a group", %{user: user} do
    ...
    assert_response "@belf Whoops! An error occurred. ERROR! Could not find group `elves`"
    ...
    assert_response "@belf Whoops! An error occurred. ERROR! Must specify a target to act upon. See `operable:help operable:group` for more details."
  ...
  test "creating a group", %{user: user} do
    ...
    send_message user, "@bot: operable:group --create test"
    assert_response "@belf Whoops! An error occurred. ERROR! The group `test` already exists."
  end
  ...
  test "adding a group to a group", %{user: user} do
    ...
    assert_response "@belf Whoops! An error occurred. ERROR! Could not find group `cheer`"
  ...
  test "errors using the group command", %{user: user} do
    ...
    assert_response "@belf Whoops! An error occurred. ERROR! Must specify a group to modify."
  end
