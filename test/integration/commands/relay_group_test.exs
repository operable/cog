defmodule Integration.Commands.RelayGroupTest do
  ...
  test "adding relays to relay groups", %{user: user} do
    ...
    response = send_message(user, "@bot: operable:relay-group member relay_group add relay")
  ...
  test "removing relays from relay groups", %{user: user} do
    ...
    response = send_message(user, "@bot: operable:relay-group member relay_group remove relay")
  ...
  test "assigning bundles to relay groups", %{user: user} do
    ...
    response = send_message(user, "@bot: operable:relay-group member relay_group assign bundle")
  ...
  test "unassigning bundles from relay groups", %{user: user} do
    ...
    response = send_message(user, "@bot: operable:relay-group member relay_group unassign bundle")
