defmodule Cog.Commands.RelayGroup.Member.Remove do
  ...
  USAGE
    relay-group member <group_name> remove [FLAGS] <relay_name ...>
  ...
  @spec remove_relays(String.t, %Cog.Command.Request{}, List.t) :: {:ok, String.t, Map.t} | {:error, any()}
  def remove_relays(group_name, req, arg_list) do
