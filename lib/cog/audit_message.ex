defmodule Cog.AuditMessage do
  ...
  def render({:terminate_pipeline, full_command_name, pipeline_id}, _request) do
    "Terminated pipeline #{pipeline_id} early while executing command #{full_command_name}"
  end
