...
config :cog, Cog.Endpoint,
  ...
  url: [host: (System.get_env("COG_API_HOST") || "localhost"),
        path: "/",
        port: (System.get_env("COG_API_PORT_EXTERNAL") || 4000)],
...
config :cog, Cog.TriggerEndpoint,
  ...
  url: [host: (System.get_env("COG_TRIGGER_HOST") || "localhost"),
        path: "/",
        port: (System.get_env("COG_TRIGGER_PORT_EXTERNAL") || 4001)],
  root: Path.dirname(__DIR__),
  debug_errors: false,
  cache_static_lookup: false,
  check_origin: true,
