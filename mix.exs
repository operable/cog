...
defmodule Cog.Mixfile do
  ...
  defp deps do
    [{:slack, github: "BlakeWilliams/Elixir-Slack"},
     ...
     {:html_entities, "~> 0.3.0"},
     {:adz, github: "operable/adz", tag: "0.10.0"},
     {:spanner, github: "operable/spanner", tag: "0.10.0"},
     {:probe, github: "operable/probe", tag: "0.10.0"},
     {:exml, github: "paulgray/exml", tag: "2.2.1"},
     {:fumanchu, github: "operable/fumanchu", tag: "0.10.0"},
     {:exirc, "~> 0.9.2"},
