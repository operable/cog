...
defmodule Cog.Mixfile do
  ...
  defp deps do
    [{:slack, "~> 0.5.0"},
     ...
     {:html_entities, "~> 0.3.0"},
     {:adz, github: "operable/adz", tag: "0.7.5"},
     {:spanner, github: "operable/spanner", tag: "0.7.5"},
     {:probe, github: "operable/probe", tag: "0.7.5"},
     {:exml, github: "paulgray/exml", tag: "2.2.1"},
     {:fumanchu, github: "operable/fumanchu", tag: "0.7.5"},
     {:exirc, "~> 0.9.2"},
