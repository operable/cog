defmodule Cog.Mixfile do
  ...
  defp deps do
    [
     ...
     {:html_entities, "~> 0.2"},
     #{:spanner, git: "git@github.com:operable/spanner", ref: "d261e2375a333f86bd2a7425bed35c73bdbe39ed"},
     {:spanner, git: "git@github.com:operable/spanner", branch: "peck/calling_convention"},
